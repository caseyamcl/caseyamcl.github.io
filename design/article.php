...
<article class='row-fluid'>
    ...
    <header class='span12'>
        <h1>SSH Tunnels with HiediSQL and Plink</h1>
        <p class='article-info'>
            Published <time pubdate="pubdate" datetime="XX">October 15, 2012</time>
            and revised <time pubdate="pubdate" datetime="XX">October 20, 2012</time>
            by <span class='author'>Casey McLaughlin</span>
        </p>
    </header>

    <section class='article-content span8 offset2'>
<p>
...
<p>
    ...
    <footer class='span12'>
        <hr />
        <p>
            This article was published on October 15, 2012 and updated on 
            November 1, 2012 by Casey McLaughlin.
        </p>
        <p>
            You can find more <a href='index.php#articles' title='Article'>articles</a> and other 
            stuff on my <a href='#' title='My Website'>website</a>.
        </p>
    </footer>
